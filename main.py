...
class MainWindow(QMainWindow):
    ...
    heartSignal = QtCore.pyqtSignal() #用于跨线程传递信号
    room = '' #房间号
    ...
    def __init__(self):
        ...
        self.heartSignal.connect(self.heartbeat) #心跳
    ...
    def initUI(self):
        ...
        #qss加载
        with open(os.path.join(basedir, 'src/style.qss')) as f:
            style = f.read()
    ...
    def heartbeat(self):
        ...
        self.beattimer.timeout.connect(self.beat)
        self.beattimer.start(60000)
    def beat(self):
        try:
            message = {
                'type': 'heartbeat',
...
nindex = QFontDatabase.addApplicationFont(os.path.join(basedir, 'src/myfont.ttf'))
if nindex!=-1:
